...
const styles = StyleSheet.create({
  ...
  // Capture state
  captureContainer: { alignItems: 'center', paddingTop: 32 },
  captureIcon: {
    width: 96,
    height: 96,
    borderRadius: 48,
  ...
  captureButtons: { flexDirection: 'row', gap: 14, marginBottom: 32, width: '100%' },
  cameraButton: {
    flex: 1,
  ...
  cameraButtonText: { ...typography.bodyBold, color: colors.white, fontSize: 16 },
  libraryButton: {
    flex: 1,
    backgroundColor: colors.glass.elevated,
    borderRadius: borderRadius.xl,
  ...
  libraryButtonEmoji: { fontSize: 32 },
  libraryButtonText: { ...typography.bodyBold, color: colors.gray[700], fontSize: 16 },
  ...
  tipsTitle: { ...typography.bodyBold, color: colors.gray[700], marginBottom: 10 },
  tipItem: { ...typography.caption, color: colors.gray[500], marginBottom: 6, lineHeight: 18 },
