...
const styles = StyleSheet.create({
  ...
  avatarCircle: {
    ...
    ...shadows.glass, borderWidth: 2, borderColor: 'rgba(255,255,255,0.50)',
  },
  ...
  householdBadge: {
    ...
    ...shadows.sm, borderWidth: 1, borderColor: 'rgba(255,255,255,0.50)',
  },
  ...
  quickAction: { alignItems: 'center', marginHorizontal: 6, width: 72 },
  quickActionIcon: {
    width: 56, height: 56, borderRadius: 20,
    backgroundColor: colors.glass.elevated, justifyContent: 'center', alignItems: 'center',
    marginBottom: 8, ...shadows.glass,
    borderWidth: 1, borderColor: 'rgba(255,255,255,0.60)',
  },
  quickActionEmoji: { fontSize: 26 },
  quickActionLabel: { ...typography.small, color: colors.gray[600], fontWeight: '600', textAlign: 'center' as const },

  dashCard: { marginBottom: 16, backgroundColor: colors.glass.card, borderWidth: 1, borderColor: 'rgba(255,255,255,0.60)', ...shadows.glass },
  dashCardHeader: {
